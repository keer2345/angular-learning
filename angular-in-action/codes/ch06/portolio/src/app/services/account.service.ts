...
export class AccountService {
  ...
  init() {
    this._stocks = this.localStorageServices.get('stocks', [])
    this._balance = this.localStorageServices.get('balance', defaultBalance)
    this._cost = this.localStorageServices.get('cost', 0)
  }
